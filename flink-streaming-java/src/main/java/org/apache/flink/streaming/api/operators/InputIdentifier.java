...
/**
 * The identifier for an input of the operator.
 */
@PublicEvolving
public final class InputIdentifier {

	/**
	 * The {@code InputIdentifier} object corresponding to the input
	 * id {@code 1}.
	 */
	...
	/**
	 * The id of the input. It's numbered from {@code 1}, and the value
	 * {@code 1} indicates the first input.
	 */
	private final int inputId;

	public InputIdentifier(int inputId) {
